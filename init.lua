...
-- [[ Setting options ]]
-- HELP: See `:help vim.opt` and :help `option-list`
...
require('lazy').setup({
    ...
    -- HELP: Use ':TodoTelescope' to search all todos with Telescope
    {
        -- NOTE: adding a note
        ...
        keys = {
            { '<leader>st', '<cmd>TodoTelescope<cr>', desc = '[S]earch [T]odotList' },
        },
    },
