---@class caleskog.nvim.core.utils.File
local M = {}
...
---@param filetypes? table<string> A list of filetypes that should be converted into `target` files. Default: {"markdown"}. For possible filetypes see: [plenary.nvim/filetypes/base.lua](https://github.com/nvim-lua/plenary.nvim/blob/master/data/plenary/filetypes/base.lua)
...
function M.convert(filepath, filetypes, targets, overwrite, to_all)
    ...
    if Core.utils.tbl.contains(filetypes, extension) then
